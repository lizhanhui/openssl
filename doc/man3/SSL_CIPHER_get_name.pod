...
SSL_CIPHER_get_mkey() returns the key exchange algorithm of the given
cipher B<c>.

SSL_CIPHER_get_auth() returns the authentication algorithm of the given
cipher B<c>.

SSL_CIPHER_get_enc() returns the symmetric encryption algorithm of the
given cipher B<c>.

SSL_CIPHER_get_mac() return the MAC algorithm of the given cipher B<c>.
...
SSL_CIPHER_get_mkey(), BABASSL_CIPHER_get_auth(),
SSL_CIPHER_get_enc() and BABASSL_CIPHER_get_mkey() return a unsigned long
