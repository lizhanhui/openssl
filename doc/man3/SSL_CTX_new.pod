...
DTLSv1_2_client_method, TLCP_method, TLCP_client_method, TLCP_server_method
...
=item TLCP_method(), TLCP_client_method(), TLCP_server_method()

These are the general-purpose I<version-flexible> TLCP methods. But now there
is only TLCPv1.1, corresponding to TLCPv1.1 and GM/T 0024-2014.
