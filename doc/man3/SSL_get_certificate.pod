...
SSL_get_use_certificate,
SSL_get_sign_certificate_tlcp, SSL_get_enc_certificate_tlcp
...
SSL_get_use_certificate() returns a pointer to an B<X509> object representing the used certificate.

SSL_get_sign_certificate_tlcp() returns a pointer to an B<X509> object
representing the used signature certificate.
SSL_get_enc_certificate_tlcp() returns a pointer to an B<X509> object
