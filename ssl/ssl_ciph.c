...
static const SSL_CIPHER cipher_aliases[] = {
    ...
    {0, TLCP_TXT_SM2DHE_WITH_SM4_SM3, NULL, 0, SSL_kSM2DHE, SSL_aSM2, SSL_SM4,
     SSL_SM3, TLCP_VERSION, TLCP_VERSION, 0, 0, SSL_HIGH,
     SSL_HANDSHAKE_MAC_SM3 | TLS1_PRF_SM3, 128, 128},
    {0, TLCP_TXT_SM2_WITH_SM4_SM3, NULL, 0, SSL_kSM2, SSL_aSM2, SSL_SM4,
     SSL_SM3, TLCP_VERSION, TLCP_VERSION, 0, 0, SSL_HIGH,
     SSL_HANDSHAKE_MAC_SM3 | TLS1_PRF_SM3, 128, 128},
#endif
...
#ifndef OPENSSL_NO_TLCP
    {0, SSL_TXT_TLCPV1_1, NULL, 0, 0, 0, 0, 0, TLCP1_1_VERSION},
#endif
...
unsigned long SSL_CIPHER_get_auth(const SSL_CIPHER *c)
{
    return c->algorithm_auth;
}

unsigned long SSL_CIPHER_get_enc(const SSL_CIPHER *c)
{
    return c->algorithm_enc;
}

unsigned long SSL_CIPHER_get_mac(const SSL_CIPHER *c)
{
