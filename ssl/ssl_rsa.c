...
static int ssl_use_certificate_file_tlcp(SSL *ssl, const char *file,
                                         int type, int tag);
static int ssl_use_PrivateKey_idx(SSL *ssl, EVP_PKEY *pkey, int i);
static int ssl_use_PrivateKey_file_tlcp(SSL *ssl, const char *file,
                                        int type, int tag);
#endif
...
{
    return ssl_use_certificate_file_tlcp(ssl, file, type, SSL_SIGN_CERT);
}
...
{
    return ssl_use_certificate_file_tlcp(ssl, file, type, SSL_ENC_CERT);
}
...
{
    return ssl_use_PrivateKey_file_tlcp(ssl, file, type, SSL_ENC_CERT);
}
...
{
    return ssl_use_PrivateKey_file_tlcp(ssl, file, type, SSL_SIGN_CERT);
}
#endif
