...
static int test_ssl_get_master_key(void)
{
    int testresult = 0;
...
static int test_ssl_debug(void)
{
    int testresult = 0;
    size_t len;
    FILE *fp;
    ...
    fp = freopen("SSL_debug.log", "w", stdout);
    SSL_debug(s, (unsigned char *)"SSL_debug",
                  sizeof("SSL_debug") - 1);
    fseek(fp, 0, SEEK_END);
...
static int test_ssl_cipher_get(void)
{
    int testresult = 0;
    SSL_CTX *cctx = NULL, *sctx = NULL;
    SSL *clientssl = NULL, *serverssl = NULL;
...
static int test_ssl_session_get_ref(void)
{
    int testresult = 0;
    SSL_CTX *cctx = NULL, *sctx = NULL;
    SSL *clientssl = NULL, *serverssl = NULL;
...
static int test_ssl_get_use_certificate(void)
{
    int testresult = 0;
    SSL_CTX *cctx = NULL, *sctx = NULL;
    SSL *clientssl = NULL, *serverssl = NULL;
...
static int test_ssl_get_cert_cb(void)
{
    int testresult = 0;
    SSL_CTX *cctx = NULL, *sctx = NULL;
    SSL *clientssl = NULL, *serverssl = NULL;
...
static int test_ssl_get0_alpn_proposed(void)
{
    int testresult = 0;
    unsigned int len;
...
static int test_ssl_get0_wbio(void)
{
    int testresult = 0;
    SSL_CTX *cctx = NULL, *sctx = NULL;
    SSL *clientssl = NULL, *serverssl = NULL;
...
static int test_ssl_ctx_certs_clear(void)
{
    int testresult = 0;
    SSL_CTX *cctx = NULL, *sctx = NULL;
    SSL *clientssl = NULL, *serverssl = NULL;
...
static int test_ssl_set_session_ctx(void)
{
    int testresult = 0;
...
static int test_ssl_client_hello_get1_extensions(void)
{
    int testresult = 0;
    SSL_CTX *cctx = NULL, *sctx = NULL;
    SSL *clientssl = NULL, *serverssl = NULL;
...
static int test_ssl_tlsext_status(void)
{
    SSL_CTX *cctx = NULL, *sctx = NULL;
    SSL *clientssl = NULL, *serverssl = NULL;
    int testresult = 0;
...
int setup_tests(void)
{
    ...
    ADD_TEST(test_ssl_debug);
    ADD_TEST(test_ssl_get_master_key);
    ADD_TEST(test_ssl_cipher_get);
    ADD_TEST(test_ssl_session_get_ref);
    ADD_TEST(test_ssl_get_use_certificate);
    ADD_TEST(test_ssl_get_cert_cb);
    ADD_TEST(test_ssl_get0_alpn_proposed);
    ADD_TEST(test_ssl_get0_wbio);
    ADD_TEST(test_ssl_ctx_certs_clear);
    ADD_TEST(test_ssl_set_session_ctx);
#ifndef OPENSSL_NO_TLS1_2
    ADD_TEST(test_ssl_client_hello_get1_extensions);
#endif
#ifndef OPENSSL_NO_OCSP
    ADD_TEST(test_ssl_tlsext_status);
#endif
    return 1;
}
